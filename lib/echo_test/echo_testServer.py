...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'echo_test'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from echo_test.echo_testImpl import echo_test  # noqa @IgnorePep8
impl_echo_test = echo_test(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'echo_test'
        ...
        self.rpc_service.add(impl_echo_test.echo,
                             name='echo_test.echo',
                             types=[dict])
